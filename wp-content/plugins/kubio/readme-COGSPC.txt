...
-   **Widget area** - The widget area block allows you to add blog widgets anywhere you want on a page or post.
...
-   **Post comment form** - If you allow blog comments, you’ll need to do this via a comment form. Customize your comments form fields, labels, buttons, links, backgrounds, and more.
...
= 2.6.4 and 2.6.4-pro =
- Enabled iConvert Promoter in Button Actions
...
= 2.2.1 and 2.2.1-pro =
- Fixed an issue where the blocks inside footer were not editable
...
= 2.1.3 and 2.1.3-pro =
- Fixed compatibility with WooCommerce 8.6.0

= 2.1.2 and 2.1.2-pro =
- Small text changes and typo fixes

= 2.1.1 and 2.1.1-pro =
- Small fix for cases when the default editor role is removed
- General bug fixes
...
- Fixed custom section issue in Kubio 2.0.0
- Fixed alternate logo issue

= 2.0.0 and 2.0.0-pro =
- Released Kubio AI feature
- Minor bug fixes
...
= 1.8.2 and 1.6.2-pro =
- Added try online URL for new Kubio themes
- Fix Chrome screen tearing
...
= 1.7.3 and 1.5.3-pro =
- Minor bug fixes for WordPress 6.2.1

= 1.7.2 =
- Allow export Kubio global styling

= 1.7.1 =
- Minor bug fixes
- Added possibility to export Kubio starter sites via CLI
...
= 1.6.4 =
- Documentation and other Kubio-related links update

= 1.6.3 =
- Fixed an issue where the dollar sign followed by a number in the WooCommerce product description was replaced with an empty string
...
- New entrance animation feature that allows blocks to appear on page scroll with an animation
